...
urlpatterns = [
    ...
    path('turma/<int:idT>/gestao/aulas/', aula.aula_listagem, name='aula_listagem'),
    # path('ajax/aulas/', aula.aula_listagem_ajax, name='aula_listagem_ajax'),
    path('turma/<int:idT>/gestao/aula/novo/', aula.aula_novo, name='aula_novo'),
    path('turma/<int:idT>/gestao/aula/alterar/<int:idA>', aula.aula_alterar, name='aula_alterar'),
